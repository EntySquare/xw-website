        ...
        <div class="tabsbody">
          <div class="body-item">
            ...
            <div class="item" v-for="(item, index) in 3" :key="index">
              ...
              <div class="imgcar">
                <LockDiv
                  :width="!mqList ? '135px' : '73px'"
                  :xyb="!mqList ? '135px' : '73px'"
                >
                  <a-avatar :size="!mqList ? 135 : 73" shape="square">
                    <img :src="imgurl" />
                  </a-avatar>
                </LockDiv>
                <a-typography-title :heading="5"> 醒目猴</a-typography-title>
                <icon-check-circle-fill style="color: blue" :size="20" />
              </div>
              <div v-if="!mqList">
                <a-typography-title :heading="6"> ¥500 </a-typography-title>
              </div>
              <div v-if="!mqList">
              ...
              <div :style="{ flex: mqList ? 'none' : '5%' }">
                <a-typography-title :heading="6"> 80000 </a-typography-title>
              </div>
              <div v-if="!mqList">
                <a-typography-title :heading="6"> 100/50 </a-typography-title>
              </div>
              <div v-if="!mqList">
                <a-typography-title :heading="6"> +7% </a-typography-title>
              </div>
            </div>
          </div>
        </div>
