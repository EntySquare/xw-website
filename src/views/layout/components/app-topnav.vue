    ...
    <div class="container containergrap">
      ...
      <div class="tab-bar containergrap">
        ...
        <DropDown title="发现">
          ...
          <DropItem @click="to('/')">
            <template #icon
              ><icon-import :size="28" style="transform: rotate(180deg)" />
            </template>
            登出
          </DropItem>
        </DropDown>
        ...
        <div class="themer">
          <a-switch
            :size="mqList ? 'small' : 'medium'"
            checked-color="#F0EBF2"
            unchecked-color="#000"
            v-model="value"
            checked-value="0"
            unchecked-value="1"
            @change="setTheme(value)"
          >
      ...
      <div class="my-setting nonetitle">
        ...
        <DropDown :left="-100" type="click" :pop_up="true">
          <template #title>
            ...
            >
              <path
                d="M575.69382709 511.6938271h0.6123458v0.6123458H575.69382709z"
                fill="#2c2c2c"
                p-id="1517"
              ></path>
              <path
